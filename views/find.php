...
<body>
    ...
    <div class="container mt-5 mb-5">
        <div class="card p-3">
            <div class="card-body">
                <div class="container">
<center><h3> ค้นหารายชื่อศิษย์เก่า  </h3></center>
<br>
  <table class="table">
	  ...
	  <div class="event_location"  align="center">รายละเอียด</div>
                ...
                <?php } else { ?>
                 <center><form name="searchform" id="searchform" method="POST" action="../Alumni/search" class="form-inline d-flex justify-content-center md-form form-sm active-cyan active-cyan-2 mt-2">
                        <input name="searchalumni" id="searchalumni" class="form-control form-control-sm ml-3 w-75" type="text" placeholder="ค้นหารายชื่อโดยการพิมพ์ ชื่อ-นามสกุล / รหัสนักศึกษา / ปีการศึกษาที่เข้า / หมู่เรียน / จังหวัด" aria-label="Search">
...
<br>
    ...
    <td><div class="event_location"  align="center"><?php echo $result["s_year"]; ?></div></td>
        ...
        <?php if (isset($_SESSION['s_id'])) { ?>
                                ...
                                <?php } else { ?>
                                    <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="กรุณาเข้าสู่ระบบ">
